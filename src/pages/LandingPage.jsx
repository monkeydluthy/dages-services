...
function InfoCard({ icon, label, value, subtext, href }) {
  return (
    <article className="flex flex-1 flex-col items-center justify-center rounded-lg border border-white/20 bg-black/20 px-4 py-5 text-center">
      {icon}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            <h2 className="text-2xl font-bold text-white sm:text-3xl">
              Still deciding? Here&apos;s how to reach Joseph.
            </h2>
            <p className="mt-3 text-base text-brandTint/80 sm:text-lg">
              Call, or fill out the form and he calls you back — usually within
              minutes.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-stretch md:gap-12">
            <div className="order-1 md:order-2">
              <div className="h-full rounded-lg bg-white p-3 shadow-xl md:p-4">
                <LeadForm plain />
              </div>
            </div>
